...
public class HeadingConverterTests
{
    private ConverterSettings? Settings { get; } = new ConverterSettings
    {
        Converter = new CompositeConverter(
            ...
            new HeadingConverter<Block.Heading1>(h1 => h1.Text, text => $"# {text}"),
            new HeadingConverter<Block.Heading2>(h1 => h1.Text, text => $"## {text}"),
            new HeadingConverter<Block.Heading3>(h1 => h1.Text, text => $"### {text}"))
    };
